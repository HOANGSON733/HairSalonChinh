...
const galleryItems: GalleryItem[] = [
  {
    id: 1,
    title: "Layer Nam - Phong Cách Hiện Đại",
    category: "hairstyles",
  ...
  {
    id: 2,
    title: "Undercut - Nét Lịch Lãm Thời Thượng",
    category: "hairstyles",
  ...
  {
    id: 3,
    title: "Dịch Vụ Duỗi Tóc - Suôn Mượt Hoàn Hảo",
    category: "services",
  ...
  {
    id: 4,
    title: "Không Gian Salon - Hiện Đại & Sang Trọng",
    category: "facility",
  ...
  {
    id: 5,
    title: "Sự Kiện Khai Trương - Dấu Ấn Đáng Nhớ",
    category: "events",
  ...
  {
    id: 6,
    title: "Mohican - Sự Cá Tính Đầy Cuốn Hút",
    category: "hairstyles",
  ...
  {
    id: 7,
    title: "Massage Đầu - Thư Giãn & Sảng Khoái",
    category: "services",
  ...
  {
    id: 8,
    title: "Thiết Bị Salon - Công Nghệ Tiên Tiến",
    category: "facility",
  ...
  {
    id: 9,
    title: "Tóc Uốn Xoăn - Nét Quyến Rũ Tự Nhiên",
    category: "hairstyles",
  ...
  {
    id: 10,
    title: "Gội Đầu Thảo Dược - Chăm Sóc Tóc Tự Nhiên",
    category: "services",
  ...
  {
    id: 11,
    title: "Sự Kiện Khuyến Mãi - Cơ Hội Đặc Biệt",
    category: "events",
  ...
  {
    id: 12,
    title: "Không Gian Sang Trọng - Đẳng Cấp & Tinh Tế",
    category: "facility",
  ...
  {
    id: 13,
    title: "Quiff - Kiểu Tóc Nam Tính & Lịch Lãm",
    category: "hairstyles",
  ...
  {
    id: 14,
    title: "Sự Kiện Salon - Nơi Gặp Gỡ & Chia Sẻ",
    category: "events",
  ...
  {
    id:15,
    title: "Tóc Uốn Xoăn - Phong Cách Hiện Đại",
    category: "hair",
    ...
    { 
      id: 16, 
      title: "Tóc Uốn Xoăn Nam - Phong Cách Tự Nhiên & Cá Tính", 
      category: "hair", 
    ...
    { 
      id: 17, 
      title: "Kiểu Tóc Uốn Xoăn - Định Hình Phong Cách", 
      category: "hair", 
    ...
    { 
      id: 18, 
      title: "Học Viện Đào Tạo - Kỹ Thuật Uốn Xoăn Chuyên Nghiệp", 
      category: "academy", 
    ...
    { 
      id: 19, 
      title: "Sự Kiện Khai Trương - Bước Đột Phá Mới", 
      category: "events", 
